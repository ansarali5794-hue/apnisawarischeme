...
export const VEHICLE_PROJECTS: VehicleProject[] = [
  ...
  },
  {
    ...
    subtitle: 'One-Time Lucky Draw Project',
    category: 'luckydraw',
    ...
    qurstandaziBenefit: 'Transparent Digital Lucky Draw on Members Completion!',
    nonWinnersRefundText: 'One-time token investment. Winner takes prize upon draw. No refund for non-winners.',
    ...
    statusBadge: 'OPEN',
    description: 'Suzuki Alto 660cc lucky draw project. One-time token price PKR 5,000. Lucky draw held once target members reach or within 6 months. Winner takes vehicle, one-time investment with no refunds.',
    specs: {
  ...
  },
  {
    ...
    statusBadge: 'OPEN',
    description: 'Eco-friendly electric bike with zero fuel expenses. One-time token price PKR 1,000. Lucky draw upon completion.',
    specs: {
