cat << 'INNER_EOF' > src/components/AdminTokenLedgerSection.tsx
import React, { useState } from 'react';
import { UserActiveProject, UserProfile, PaymentRecord, VehicleProject } from '../types';
import { Search, FileSpreadsheet, Calendar, ChevronDown, ChevronUp } from 'lucide-react';
                    ...
                    <React.Fragment key={act.id}>
                      ...
                      >
                        ...
                        <td className="p-3 text-xs text-center font-bold">
                          <button className="text-[#98001b] flex items-center gap-1 justify-center w-full">
